...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char ogg_activationAihub_start[] asm("_binary_activationAihub_ogg_start");
        extern const char ogg_activationAihub_end[] asm("_binary_activationAihub_ogg_end");
        static const std::string_view OGG_ACTIVATIONAIHUB {
        static_cast<const char*>(ogg_activationAihub_start),
        static_cast<size_t>(ogg_activationAihub_end - ogg_activationAihub_start)
        };
